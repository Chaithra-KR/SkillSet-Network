  ...
  return (
    ...
    >
      <form
        ...
        className="w-full max-w-md p-10 bg-white bg-opacity-90  rounded-lg shadow-md"
      >
        ...
        <fieldset className="bg-white mb-4 rounded-lg  ">
          <ul className="m-1 p-1">
            ...
            <li className="mb-4">
              <label htmlFor="password" className="text-left block pb-2">
                Password:
              </label>
              <input
