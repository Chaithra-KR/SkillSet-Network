    ...
    try {
      const handleDashboard = async () => {
        await adminAxiosInstance
          .get(`${AdminApi}viewDashboard?data=${encodeURIComponent(token)}`)
          .then((res) => {
        ...
        <div>
          <div className="bg-gray-100 rounded-lg p-3 h-24 w-72 m-7">
            ...
            <p className="text-2xl text-gray-500">
              <span className="font-bold ml-16">Rs.{revenue}/-</span>
            </p>
          </div>
          <div className="bg-gray-100 rounded-lg p-3 h-24 w-72 m-7">
            ...
            <p className="text-sm text-gray-500">
              ...
              <span className="font-bold text-xl">{premiumAccountsCount}</span>
            </p>
          </div>
          <div className="bg-gray-100 rounded-lg p-3 h-24 w-72 m-7">
            ...
            <p className="text-sm text-gray-500">
              Total users:{" "}
              <span className="font-bold text-xl">{userCount}</span>
            </p>
          </div>
          <div className="bg-gray-100 rounded-lg p-3 h-24 w-72 m-7">
            ...
            <p className="text-sm text-gray-500">
              Total Companies:{" "}
              <span className="font-bold text-xl">{companyCount}</span>
            </p>
          </div>
        </div>
      </div>
