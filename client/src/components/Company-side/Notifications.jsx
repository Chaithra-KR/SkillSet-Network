...
import { FaEnvelope ,FaUser , FaPhone , FaCode} from "react-icons/fa";
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="space-x-2">
                    ...
                    <Modal
                      ...
                      onCancel={closeModal}
                    >
                      <p className="mb-2"><span className="font-bold mr-1">Subject :</span> Application for<span className="ml-1 font-bold">{val.job.position}</span> at you company</p>

                      <p>Dear sir,</p>

                      <p className="mb-1">I am writing to apply for the <span className="font-bold mr-1">{val.job.position}</span> position at your company.
                       Attached is my CV outlining my relevant skills{val.experience ? (<scan className='ml-1'>and  <span className="font-bold">{val.experience}.</span></scan>)
                       :(<scan>.</scan>)} </p>

                        <p className="mb-1">
                          I have a strong track record in{" "}<span className="font-bold mr-1">
                          {val.skills.map((skill, i) => (
                            <>
                              {skill}
                              {val.skills.length - 2 === i ? " and " : val.skills.length - 1 === i ? "" : ", "}
                            </>
                          ))}</span>.
                          I am eager to bring these skills to your company and contribute to your team's success.
                        </p>

                      <p className="mb-1">I am available for an interview at <span className="font-bold mr-1">{val.phone}</span> or via email at <span className="font-bold mr-1">{val.email}</span>.</p>
                       <p className="mb-2">Thank you for considering my application.</p>
            ...
            <ul className="mt-2 flex flex-wrap">
              ...
              >
                ...
                <div className="mt-4 text-center">
                  ...
                  <button className="border rounded text-black hover:bg-pink-500 hover:text-white px-4 py-2 ml-2">
                    Profile
                  </button>
                </div>
              </li>
