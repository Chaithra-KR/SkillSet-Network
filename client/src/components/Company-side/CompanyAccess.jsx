  ...
  return (
    <div className="relative">
      ...
      <div>
        {currentView ? (
          <>
            <div className="w-full max-w-4xl max-h-[700px]  p-4 bg-white bg-opacity-90 rounded-lg shadow-md">
              <form onSubmit={handleSubmit(submitData)}>
                ...
                {button ? (
                  <button className="px-4 py-2 border cursor-pointer w-[500px] rounded-lg shadow hover:text-white bg-white hover:bg-gray-500 hover:border-gray-300">
                    Submit
                  </button>
                ) : (
                  <button
          ...
          <>
            <div className="w-[500px] p-4 bg-white bg-opacity-90 rounded-lg shadow-md">
