  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const matchedJobs = response.data.matchedJobs;
        const jobData = response.data.jobs;
        const jobPosition = response.data.jobPosition;
        const totalCount = response.data.totalCount;
        const paginationCount = response.data.paginationCount;
          ...
          <li className="w-full md:w-1/4" key={i}>
            <div className="box mb-4 p-4 text-center shadow-md">
              <div className="bg-pink-50 h-32 mb-2">
                ...
                <div>
                  <p className="text-sm">
                    at <span className="font-bold"> {val.company.company}</span>
                  </p>
                </div>
                <div>
              ...
              >
                <h1 className="text-xl font-bold pb-3">
                  {val.position}{" "}
                  <span className="text-sm">( {val.company.company} )</span>
                </h1>
                <div className="mb-3">
                ...
                <p className="text-pink-500">
                  {val.skills.length} skills match your profile - you may be a
                  good fit
                </p>
                <div className="mt-3">
                ...
                >
                  ...
                  <button onClick={()=>{handleApplyJob(val._id)}} className="p-1 mt-2 w-16 border border-transparent  text-white rounded-full bg-pink-700 shadow-md ml-2 hover:bg-pink-400">
                  Apply
                </button>
              </Modal>
            </div>
              ...
              <div className="box mb-4 p-4 text-center shadow-md">
                <div className="bg-pink-50 h-32 mb-2">
                  ...
                  <div>
                    <p className="text-sm">
                      at{" "}
                      <span className="font-bold"> {job.company.company}</span>
                    </p>
                  </div>
                  <div>
                    <p className="font-bold">Required skills :</p>
                ...
                >
                  <h1 className="text-xl font-bold pb-3">
                    {job.position}{" "}
                    <span className="text-sm">( {job.company.company} )</span>
                  </h1>
                  <div className="mb-3">
                    <div className="flex items-center">
                      <span className="w-8 font-bold">
    ...
    <div>
      <div className="flex justify-center">
        <span className="text-gray-500 ">
          Page {Math.min(page, paginationCount)} of {paginationCount}
        </span>
      </div>
