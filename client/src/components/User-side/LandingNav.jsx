  ...
  return (
    <div className='h-16 w-full bg-white'>
        <div className='flex justify-between'>
            ...
            <button onClick={handleSeekOrCompany} className="p-1 w-20 ml-5 border border-pink-400 text-black rounded bg-pink-100 shadow-md hover:bg-pink-400">SignUp</button> 
