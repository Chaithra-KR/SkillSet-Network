  ...
  useEffect(() => {
    const handleNetwork = async () => {
      try {
        ...
        setRequestTo(response.data.requestTo);
    ...
    <div className="w-full h-screen bg-white">
      <div className="flex justify-center">
        <div className="mx-2">
          <div className="flex flex-wrap justify-between py-3">
            <div className="flex flex-wrap">
              <button
                ...
                className={`border border-transparent bg-gray-100 rounded flex px-2 flex-raw items-center ${
              ...
              <button
                ...
                className={`ml-2 border border-transparent bg-gray-100 rounded flex px-2 flex-raw items-center ${
          ...
          <div className="bg-gray-100 w-full md:w-[800px] xl:w-[1200px] rounded p-5 h-[600px] overflow-y-auto">
                ...
                {requests.length > 0 ? (
                  <div>
                    {requests.map((element, i) => (
                      <div
                        key={i}
                        className="p-4 bg-white w-[800px] rounded-lg shadow-md mb-3"
                      >
