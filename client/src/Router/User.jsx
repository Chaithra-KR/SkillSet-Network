    ...
    <Fragment>
      <ErrorBoundary FallbackComponent={ErrorFallback}>
        <Routes>
          ...
          <Route
            path="/seek-Or-com"
            element={!seeker ? <SeekerOrCompany /> : <UserHome />}
          />
          ...
          <Route
            path="/login"
            element={!seeker ? <UserAccess /> : <UserHome />}
          />
          ...
          <Route
            path="/home"
            element={seeker ? <UserHome /> : <UserAccess />}
          />

          <Route
            path="/my-profile"
            element={seeker ? <UserProfile /> : <UserAccess />}
          />

          <Route
            path="/edit-myProfile"
            element={seeker ? <EditUserProfile /> : <UserAccess />}
          />
          ...
          <Route
            path="/saved-jobs"
            element={seeker ? <Saved /> : <UserAccess />}
          />

          <Route
            path="/apply-job"
            element={seeker ? <JobApplyNow /> : <UserAccess />}
          />

          <Route
            path="/change-password"
            element={seeker ? <ResetPassword /> : <UserAccess />}
          />

          <Route
            path="/chat-with-company"
            element={seeker ? <ChatWithCompany /> : <UserAccess />}
          />
        </Routes>
      </ErrorBoundary>
    </Fragment>
