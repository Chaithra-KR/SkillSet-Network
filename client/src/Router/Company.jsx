    ...
    <Fragment>
      <ErrorBoundary FallbackComponent={ErrorFallback}>
        <Routes>
          <Route
            path="/company-login"
            element={!company ? <CompanyAccess /> : <CentralHub />}
          />
          ...
          <Route
            path="/company-otp"
            element={!company ? <CompanyOTP /> : <CentralHub />}
          />

          <Route
            path="/company-premium"
            element={!company ? <CompanyPremium /> : <CentralHub />}
          />

          <Route
            path="/central-hub"
            element={company ? <CentralHub /> : <CompanyAccess />}
          />

          <Route
            path="/company-profile"
            element={company ? <CompanyProfile /> : <CompanyAccess />}
          />

          <Route
            path="/company-editProfile"
            element={company ? <EditCompanyProfile /> : <CompanyAccess />}
          />

          <Route
            path="/company-Jobs"
            element={company ? <JobScheduling /> : <CompanyAccess />}
          />

          <Route
            path="/notifications"
            element={company ? <Notification /> : <CompanyAccess />}
          />

          <Route
            path="/view-userProfile"
            element={company ? <UserProfileView /> : <CompanyAccess />}
          />

          <Route
            path="/singlePost"
            element={company ? <SinglePostView /> : <CompanyAccess />}
          />

          <Route
            path="/change-password"
            element={company ? <ResetPassword /> : <CompanyAccess />}
          />
